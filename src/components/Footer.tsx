...
const cols = [
  { title: "ABOUT MAX", links: ["About Us", "Stores", "Careers", "Press", "Sustainability"] },
    ...
    <footer style={{ background: "#1A1A1A" }} className="text-[var(--footer-txt)] mt-12">
          ...
          <div key={c.title}>
            ...
            {c.title === "ABOUT MAX" ? (
              <p className="text-[12px]" style={{ color: "#CCC", lineHeight: 1.6 }}>
                Max Fashion is India's leading value fashion brand offering trend-forward styles for the entire family.
              </p>
            ) : (
      ...
      <div style={{ background: "#111", borderTop: "1px solid #333" }}>
        <div className="max-container py-4 flex flex-col md:flex-row gap-3 items-center justify-between">
          <p className="text-[12px]" style={{ color: "#888" }}>© 2025 Max Fashion India Pvt Ltd | Privacy Policy | Terms of Use | Sitemap</p>
